let CHANNEL_NAME,OAUTH_TOKEN,BOT_USERNAME,rolldie,fetch;_bda‍.w("./constants",[["CHANNEL_NAME",["CHANNEL_NAME"],function(v){CHANNEL_NAME=v}],["OAUTH_TOKEN",["OAUTH_TOKEN"],function(v){OAUTH_TOKEN=v}],["BOT_USERNAME",["BOT_USERNAME"],function(v){BOT_USERNAME=v}]]);_bda‍.w("./variables",[["rolldie",["rolldie"],function(v){rolldie=v}]]);_bda‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);console.log('app started');
...
if (commandName === '!win') {
    ...
    _bda‍.g.console.log(wincounter = parseInt(wincounter) + 1);
};
if (commandName === '!loss') {
    _bda‍.g.console.log(losscounter = parseInt(losscounter) + 1);
...
if (commandName === '!reset') {
	...
	wincounter = 0;
	losscounter = 0;
	_bda‍.g.console.log(wincounter,losscounter)
