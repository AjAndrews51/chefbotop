let CHANNEL_NAME,OAUTH_TOKEN,BOT_USERNAME,rolldie,fetch;_f0e‍.w("./constants",[["CHANNEL_NAME",["CHANNEL_NAME"],function(v){CHANNEL_NAME=v}],["OAUTH_TOKEN",["OAUTH_TOKEN"],function(v){OAUTH_TOKEN=v}],["BOT_USERNAME",["BOT_USERNAME"],function(v){BOT_USERNAME=v}]]);_f0e‍.w("./variables",[["rolldie",["rolldie"],function(v){rolldie=v}]]);_f0e‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);console.log('app started');
...
if(isModUp) {
 ...
 if(commandName === '!dq') {  
  ...
  .del()
  .then()
  knex('queue').raw('ALTER TABLE ' + 'queue' + ' AUTO_INCREMENT = 1')
  .then()
...
if (commandName === '!win') {
    ...
    _f0e‍.g.console.log(wincounter = parseInt(wincounter) + 1);
    fs.writeFile('winloss.txt', wincounter + "-" + losscounter, fuck)
};
if (commandName === '!loss') {
    _f0e‍.g.console.log(losscounter = parseInt(losscounter) + 1);
...
if (commandName === '!reset') {
	...
	wincounter = 0;
	losscounter = 0;
	_f0e‍.g.console.log(wincounter,losscounter)
