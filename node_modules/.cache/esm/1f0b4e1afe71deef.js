let CHANNEL_NAME,OAUTH_TOKEN,BOT_USERNAME,rolldie,fetch;_fe7‍.w("./constants",[["CHANNEL_NAME",["CHANNEL_NAME"],function(v){CHANNEL_NAME=v}],["OAUTH_TOKEN",["OAUTH_TOKEN"],function(v){OAUTH_TOKEN=v}],["BOT_USERNAME",["BOT_USERNAME"],function(v){BOT_USERNAME=v}]]);_fe7‍.w("./variables",[["rolldie",["rolldie"],function(v){rolldie=v}]]);_fe7‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);console.log('app started');
...
if (commandName === '!win') {
    ...
    _fe7‍.g.console.log(wincounter = parseInt(wincounter) + 1);
};
if (commandName === '!loss') {
    _fe7‍.g.console.log(losscounter = parseInt(losscounter) + 1);
...
if (commandName === '!reset') {
	...
	wincounter = 0;
	losscounter = 0;
	_fe7‍.g.console.log(wincounter,losscounter)
